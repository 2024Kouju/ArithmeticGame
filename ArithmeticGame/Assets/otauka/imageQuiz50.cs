...
public class imageQuiz50 : MonoBehaviour
{
    public AudioSource CirclesoundEffect;

    public AudioSource IncorrectsoundEffect;

    public List<ImageQuestionData50> questions;

    private List<ImageQuestionData50> remainingQuestions;
    ...
    private ImageQuestionData50 currentQuestion;
    ...
    {
        remainingQuestions = new List<ImageQuestionData50>(questions);
        ...
        for (int i = 0; i < remainingQuestions.Count; i++)
        {
            ...
            ImageQuestionData50 temp = remainingQuestions[i];
...
[System.Serializable]
public class ImageQuestionData50
{
    public Sprite image;
...
// 選択肢データ
public class ImageChoiceData50
{
