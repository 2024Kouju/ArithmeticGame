...
public class imageQuiz5 : MonoBehaviour
{
    public AudioSource CirclesoundEffect;

    public AudioSource IncorrectsoundEffect;

    public List<ImageQuestionData5> questions;

    private List<ImageQuestionData5> remainingQuestions;
    ...
    private ImageQuestionData5 currentQuestion;
    ...
    {
        remainingQuestions = new List<ImageQuestionData5>(questions);
        ...
        for (int i = 0; i < remainingQuestions.Count; i++)
        {
            ...
            ImageQuestionData5 temp = remainingQuestions[i];
    ...
    void CheckAnswer(int index)
    {
        ...
        else
        {
            ...
            string correctAnswer = currentQuestion.choices5[currentQuestion.correctIndex5];
...
[System.Serializable]
public class ImageQuestionData5
{
    public Sprite image;
