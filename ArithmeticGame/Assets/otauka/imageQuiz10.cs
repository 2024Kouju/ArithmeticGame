...
public class imageQuiz10 : MonoBehaviour
{
    public AudioSource CirclesoundEffect;

    public AudioSource IncorrectsoundEffect;

    public List<ImageQuestionData10> questions;

    private List<ImageQuestionData10> remainingQuestions;
    ...
    private ImageQuestionData10 currentQuestion;
    ...
    {
        remainingQuestions = new List<ImageQuestionData10>(questions);
        ...
        for (int i = 0; i < remainingQuestions.Count; i++)
        {
            ...
            ImageQuestionData10 temp = remainingQuestions[i];
...
[System.Serializable]
public class ImageQuestionData10
{
    public Sprite image;
...
// 選択肢データ
public class ImageChoiceData10
{
